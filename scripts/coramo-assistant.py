...
Pipeline: VAD (CPU) -> whisper base (GPU 1) -> check "coramo" -> Qwen3-4B (GPU 0) -> Piper TTS
...
WHISPER_MODEL_QUERY  = os.path.expanduser("~/whisper.cpp/models/ggml-base.bin")              # base fp32 (~2.5s en GPU1 con flash-attn)
