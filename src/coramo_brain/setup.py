...
setup(
    ...
    entry_points={"console_scripts": ["safety = coramo_brain.nodes.safety_node:main", "body_bridge_sim = coramo_brain.nodes.body_bridge_sim_node:main", "tts = coramo_brain.nodes.tts_node:main"]},
)
